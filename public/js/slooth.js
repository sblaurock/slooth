...
define('audio',['data'], function(Data) {
  var buffer = null;
  var position = 0;
...
define('host',['session'], function(Session) {
  subscribers = [];
...
define('subscriber',['session'], function(Session) {
  var host = null;
...
require(['audio', 'data', 'host', 'session', 'subscriber'], function(Audio, Data, Host, Session, Subscriber) {
  window.Slooth = {
    Audio: Audio,
    Data: Data,
    Host: Host,
...
define("src/initialize", function(){});
